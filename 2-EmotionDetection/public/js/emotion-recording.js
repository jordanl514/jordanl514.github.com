...
//transcription here - whisper OpenAI TTS
//transcription here - sending info of both to another gpt call
...
const mimeType = {mimeType: 'audio/mp4'}
const timeslice = 4000
const openai = new OpenAI();

async function main() {
    console.log("main executed")
    let mimeDebug = 'audio/mp4'
    let debugStatus = MediaRecorder.isTypeSupported(`${mimeDebug}`) // false
    console.log(`${mimeDebug}`, debugStatus)
